...
public class RedisConfig extends CachingConfigurerSupport {
     ...
     */
    @Bean
    @ConditionalOnProperty(name = {"spring.redis.mode"}, havingValue = IMSCons.REDIS_MODE_CLUSTER)
    ...
    @Bean
    @ConditionalOnProperty(name = {"spring.redis.mode"}, havingValue = IMSCons.REDIS_MODE_SINGLE)
